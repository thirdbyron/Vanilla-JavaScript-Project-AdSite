...
export const formatDate = (timestamp) => new Date(Number(timestamp));

export const getDateString = (date) => `${date.getDate()} ${months[date.getMonth()]} ${date.getFullYear()}`;

export const getPublishDateString = (date) => {
